                                                    ...
                                                    <li class="item">
                                                        <div class="product-item">
                                                            <div class="product-shop-top">
                                                                <a href="{{asset('/chi-tiet-san-pham/'.$product_cate->alias)}}" title="{{$product_cate->alias}} " class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="{{asset($product_cate->anhdaidien)}}" width="220" height="220"/> 
                                                                ...
                                                                <div class="bottom">
                                                                    ...
                                                                    <div class="quickshop-link-container"> <a href="{{asset('/chi-tiet-san-pham/'.$product_cate->alias)}}" class="quickshop-link" title="Chi tiết sản phẩm">Chi tiết sản phẩm</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="product-shop">
                                                                <div class="f-fix">
                                                                    <h2 class="product-name text-center  "><a href="{{asset('/chi-tiet-san-pham/'.$product_cate->alias)}}" title="{{$product_cate->ten}}"> {{$product_cate->ten}} </a></h2>
