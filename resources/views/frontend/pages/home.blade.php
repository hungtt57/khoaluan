                            ...
                            <div class="em-main-container em-col2-left-layout">
                                <div class="row">
                                                                                        ...
                                                                                        <div class="emcatalog-desktop-4" id="em-grid-mode-em_fashion_new_arrivals_tab01">
                                                                                            <div class="products-grid ">
                                                                                                ...
                                                                                                <div class="item first" style="  ">
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title=" Embellished Mirror Pastel" class="product-image"><img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp5_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp5_2.jpg')}}" alt=" Embellished Mirror Pastel" height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp5_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp5_1.jpg')}}" alt=" Embellished Mirror Pastel" height="350" width="350">
                                                                                                            </a>
                                                                                                ...
                                                                                                <div class="item" style="  ">
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title=" Metallic Midi Cut Out Midi Dress" class="product-image"><img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp12_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp12_2.jpg')}}" alt=" Metallic Midi Cut Out Midi Dress" height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp12_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp12_1.jpg')}}" alt=" Metallic Midi Cut Out Midi Dress" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title=" Pretty Playsuit" class="product-image">
                                                                                                                ...
                                                                                                                <img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp19_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp19_2.jpg')}}" alt=" Pretty Playsuit" height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp19_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp19_1.jpg')}}" alt=" Pretty Playsuit" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="A Line Skirt" class="product-image">
                                                                                                                ...
                                                                                                                <img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp8_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp8_2.jpg')}}" alt="A Line Skirt" height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp8_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp8_1.jpg')}}" alt="A Line Skirt" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="ASOS Jumpsuit " class="product-image">
                                                                                                                ...
                                                                                                                <img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp13_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp13_2.jpg')}}" alt="ASOS Jumpsuit " height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp13_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp13_1.jpg')}}" alt="ASOS Jumpsuit " height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="ASOS Mini Skirt" class="product-image">
                                                                                                                ...
                                                                                                                <img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp6_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp6_2.jpg')}}" alt="ASOS Mini Skirt" height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp6_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp6_1.jpg')}}" alt="ASOS Mini Skirt" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="Cross Back Dress" class="product-image">
                                                                                                                ...
                                                                                                                <img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp1_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp1_2.jpg')}}" alt="Cross Back Dress" height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp1_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp1_1.jpg')}}" alt="Cross Back Dress" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="Drape Back Playsuit " class="product-image">
                                                                                                                ...
                                                                                                                <img style="" class="em-alt-hover img-responsive em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp17_2.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp17_2.jpg')}}" alt="Drape Back Playsuit " height="350" width="350">
                                                                                                                <img class="img-responsive em-alt-org em-lazy-loaded" src="{{asset('public/frontend/images/product/350x350/clothing_sp17_1.jpg')}}" data-original="{{asset('public/frontend/images/product/350x350/clothing_sp17_1.jpg')}}" alt="Drape Back Playsuit " height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title=" Embellished Mirror Pastel" class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp5_2.jpg')}}" alt=" Embellished Mirror Pastel" height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp5_1.jpg')}}" alt=" Embellished Mirror Pastel" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title=" Metallic Midi Cut Out Midi Dress" class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp12_2.jpg')}}" alt=" Metallic Midi Cut Out Midi Dress" height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp12_1.jpg')}}" alt=" Metallic Midi Cut Out Midi Dress" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title=" Pretty Playsuit" class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp19_2.jpg')}}" alt=" Pretty Playsuit" height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp19_1.jpg')}}" alt=" Pretty Playsuit" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="A Line Skirt" class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp8_2.jpg')}}" alt="A Line Skirt" height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp8_1.jpg')}}" alt="A Line Skirt" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="ASOS Jumpsuit " class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp13_2.jpg')}}" alt="ASOS Jumpsuit " height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp13_1.jpg')}}" alt="ASOS Jumpsuit " height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="ASOS Mini Skirt" class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp6_2.jpg')}}" alt="ASOS Mini Skirt" height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp6_1.jpg')}}" alt="ASOS Mini Skirt" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="Cross Back Dress" class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp1_2.jpg')}}" alt="Cross Back Dress" height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp1_1.jpg')}}" alt="Cross Back Dress" height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                                                                                    ...
                                                                                                    <div class="product-item">
                                                                                                        <div class="product-shop-top">
                                                                                                            <a href="#" title="Drape Back Playsuit " class="product-image">
                                                                                                                ...
                                                                                                                <img class="em-alt-hover img-responsive em-img-lazy" src="{{asset('public/frontend/images/product/350x350/clothing_sp17_2.jpg')}}" alt="Drape Back Playsuit " height="350" width="350">
                                                                                                                <img class="img-responsive em-img-lazy em-alt-org" src="{{asset('public/frontend/images/product/350x350/clothing_sp17_1.jpg')}}" alt="Drape Back Playsuit " height="350" width="350">
                                                                                                            </a>
                                                                                                            <div class="em-element-display-hover bottom">
                                                                                                                <div class="em-btn-addto">
                                                                                                                    <!--product add to cart-->
                                    ...
                                    <div class="col-sm-6 col-sm-pull-18 em-col-left em-sidebar">
                                                            ...
                                                            <div class="em_nav" id="toogle_menu_5_4607">
                                                                <ul class="vnav em-menu-icon effect-menu em-menu-long">
                                                                                                        ...
                                                                                                        <ul class="menu-container">
                                                                                                            <li class="menu-item-text menu-item-depth-5  ">
                                                                                                                <div class="menu-cate effect03 zoom-img">
                                                                                                                    <a title="em-sample-title" href="#"><img class="img-responsive" src="{{asset('public/frontend/images/menu/menu-img01.jpg')}}" alt="em-sample-alt" />
                                                                                                                    </a>
                                                                                                                </div>
                                                                                                            </li>
                                                                                                        </ul>
                                                                    ...
                                                                    <li class="menu-item-link menu-item-depth-0 fa fa-camera menu-item-parent">
                                                                        ...
                                                                        <ul class="menu-container" style="background-image:url(images/menu/16212167333_1dfb4ccb4d_b.jpg); background-repeat:no-repeat; background-position:right bottom;">
                                                                                                ...
                                                                                                <ul class="menu-container">
                                                                                                    <li class="menu-item-vbox menu-item-depth-4 col-sm-12 menu-item-parent" style="">
                                                                                                        <ul class="menu-container">
                                                                                                            <li class="menu-item-text menu-item-depth-5  ">
                                                                                                                <p class="img-center">
                                                                                                                    <a href="#" title="em-sample-title"><img class="img-responsive" src="{{asset('public/frontend/images/menu/logo-menu.jpg')}}" alt="em-sample-alt" />
                                                                                                                    </a>
                                                                                                                </p>
                                        ...
                                        <div class="em-wrapper-banners hidden-xs">
                                            <div class="em-effect06">
                                                <a class="em-eff06-04" href="#"><img class="img-responsive retina-img" alt="em_ads_01.jpg" src="{{asset('public/frontend/images/wysiwyg/em_ads_01.jpg')}}" />
                                                </a>
                                            </div>
                                        </div><!--  /.em-wrapper-banners -->
                                        <div class="row">
                                                    ...
                                                    <div class="em-slider em-slider-category" data-emslider-pagination="true" data-emslider-items="1">
                                                        <div class="em-ads-item">
                                                            <div class="em-ads-img">
                                                                <a href="#"><img class="img-responsive" alt="em_ads_02.png" src="{{asset('public/frontend/images/wysiwyg/em_ads_02.png')}}" />
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="em-from-our-blog">
                                                            <div class="em-blog-item em-effect-13">
                                                                <div class="em-blog-content bkg-top">
                                                                    <a title="em-sample-title" class="img-banner-small" href="#"> <img alt="em_blog" class="img-responsive" src="{{asset('public/frontend/images/blog/em_ads_07_1.jpg')}}" /> </a>
                                                            ...
                                                            <div class="em-blog-item em-effect-13">
                                                                <div class="em-blog-content bkg-top">
                                                                    <a title="em-sample-title" class="img-banner-small" href="http://demo.emthemes.com/everything/index.php/blog/11-emerging-jewelry-designers-you-need-to-know.html"> <img alt="em_blog" class="img-responsive" src="{{asset('public/frontend/images/blog/em_ads_08.jpg')}}" /> </a>
                                                                    <div class="em-blog-time">
                                                                        <p class="em-blog-date">21</p>
                                                                        <p class="em-blog-month">Jul</p>
                                                                    </div>
