                                                        ...
                                                        <div class="em-from-our-blog">
                                                            ...
                                                            <div class="em-blog-item em-effect-13">
                                                                <div class="em-blog-content bkg-top">
                                                                    <a title="em-sample-title" class="img-banner-small" href="{{asset('/blog_detail/'.$blog->id.'/'.$blog->alias)}}"> <img alt="em_blog" class="img-responsive" src="{{asset($blog->image)}}" /> </a>
                                                                    
                                                                    <div class="hov">&nbsp;</div>
                                                                </div>
                                                                <div class="em-box bkg-bottom">
                                                                    <h4 class="em-blog-title"><a href="{{asset('/blog_detail/'.$blog->id.'/'.$blog->alias)}}">{{$blog->title}}</a></h4>
                                                                    <p class="em-blog-des">{{$blog->description}}&hellip;</p>
                                                                    <p><a class="link-more" href="{{asset('/blog_detail/'.$blog->id.'/'.$blog->alias)}}">Đọc thêm</a>
                                                                    </p>
                                                                </div>
                                                            </div><!-- /.em-blog-item -->
                                                            @endforeach
