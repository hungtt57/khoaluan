...
class __TwigTemplate_41f7aa40192336923a2284472f9df65c446f11f38d962bd9b1286d91a99848a8 extends Twig_Template
{
    ...
    ";
        ...
        if ((isset($context["arePiwikProAdsEnabled"]) ? $context["arePiwikProAdsEnabled"] : $this->getContext($context, "arePiwikProAdsEnabled"))) {
            // line 21
            echo "        <h3>";
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Installation_PiwikProAdTitle")), "html", null, true);
            echo "</h3>
        <p>
            ";
            // line 23
